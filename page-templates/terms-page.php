...
get_header(); ?>
	...
	<div class="grid-12 pad-3-vert">	
		<div class="center brand_bc pad-3-bottom"><a href="https://hannahsowd.com/shop/">Shop</a> / <?php the_title(); ?></div>
		<?php if ( have_posts() ) : ?>
		...
		<div class="grid-8 l-grid-6 m-grid-12 s-grid-12 offset-2 l-offset-3 m-offset-0 s-offset-0 m-pad-3-sides s-pad-3-sides pad-3-vert">
	...
	<?php if( get_field('terms_info') ): ?>	
		...
		<div class="grid-8 l-grid-6 m-grid-12 s-grid-12 offset-2 l-offset-3 m-offset-0 s-offset-0 m-pad-3-sides s-pad-3-sides pad-3-vert hsgray">
	...
	<?php endif; ?>
    	...
    	<div class="grid-8 l-grid-6 m-grid-12 s-grid-12 offset-2 l-offset-3 m-offset-0 s-offset-0 m-pad-3-sides s-pad-3-sides pad-3-bottom pad-1-top">
				
			<h5 class="center hsslate"><?php the_sub_field('terms_title'); ?></h5>
				
		</div>	

		<div class="grid-8 l-grid-6 m-grid-12 s-grid-12 offset-2 l-offset-3 m-offset-0 s-offset-0 m-pad-3-sides s-pad-3-sides pad-2-vert">
